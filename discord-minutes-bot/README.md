...
> ⚠️ **重要な制限事項**: Discord が導入した DAVE (End-to-End Encryption) プロトコルにより、**現在 Bot 経由での音声録音は動作しません**。py-cord の [Issue #3139](https://github.com/Pycord-Development/pycord/issues/3139) で進捗を追跡できます。
